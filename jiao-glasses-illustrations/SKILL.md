---
name: jiao-glasses-illustrations
description: 生成带“小镜”个人线稿 IP 的中文正文配图。用于用户明确要求“用我的形象”“用眼镜女孩形象”“小镜”“个人 IP 版本”来为中文文章、帖子、博客、Notion 文档、工作流文档、方法论、流程、结构、状态、隐喻或观点生成手绘正文配图、配图建议、shot list 或改图；默认使用圆框眼镜、碎刘海、中长发、平静浅笑的线稿人物 IP，纯白手绘、少量红橙蓝批注、清爽但有创意的视觉风格。
---
...
默认视觉 IP 是“小镜”：圆框眼镜、碎刘海、略凌乱中长发、平静浅笑的黑白线稿人物。小镜不是头像贴纸，也不是二次元海报主角，而是正在认真参与系统运转的“安静系统操作员”。小镜必须参与画面的核心动作，不能只是站在旁边当装饰。
...
- `references/xiaohei-ip.md`：小镜 IP 的形象、性格、动作库和禁忌。
...
不要复刻过往案例。案例只提供风格密度和人物参与方式，不能直接复用“传送带断点 / 拉线 / 素材鱼 / 盖章工具箱 / 常见坑路径”等已有构图，除非用户明确要求复刻某张图。每次都要从当前文章重新发明一个奇怪但成立的隐喻。
