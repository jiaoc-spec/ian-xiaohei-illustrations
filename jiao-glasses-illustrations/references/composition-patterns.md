...
画法：左侧输入，中间小镜或怪机器处理，右侧输出，橙色箭头表达主流向。

### 系统局部

适合：信息来源、过滤器、数据库、渲染器、agent 系统局部。

画法：只画 3-5 个核心模块，小镜参与其中一个关键动作。
...
画法：一层层盒子，不要正式金字塔；小镜在旁边调试、分拣或搭建。

### 地图路线

适合：从想法到上线、用户路径、内容承接路径、学习路线。

画法：一条弯曲路径，少量节点，小镜牵线、挂卡片或走路。
...
3. 让小镜承担动作：不是站旁边，而是调试机器、过滤信息、缝合断点、接住卡片、记录事实、把东西送进某个怪装置。
...
- 拉、挂、塞、捞、压、称、缝、剪、拧、守、推、接、拆、标记、回收、校准、记录。
- 动作要服务核心意思，不要为了怪而怪。

## 反复刻规则

不要默认打开或复刻 `assets/examples/`。这些图片只用于风格校准，例如线条密度、留白、颜色克制、小镜参与方式。

除非用户明确说“照这张 / 复刻这个构图 / 用这个案例改”，否则不要直接复用这些旧构图：

- 传送带两个断点
- 人物在内容机器里拉判断杆
- 人物变成装饰性的漏斗分拣流量/信任/转化
- 人物切素材鱼
- 人物牵承接路径
- 人物拉三层信息源
- 三个人物分别拿喇叭/搭桥/开门
...
同类主题也要换新隐喻。例如“承接路径”不一定画路线，可以画小镜把内容尾巴接到门把手；“一鱼多吃”不一定画鱼，可以画小镜把一个纸团压成几种形状。
